...
const mainNav = [
  ...
  { href: "/presets",        icon: Bookmark,       label: "パワーアクション" },
  { href: "/spec-generator", icon: FileText,       label: "仕様書から自動生成", badge: "Phase 3" },
  { href: "/history",        icon: History,        label: "実行履歴" },
];

const adminNav = [
  { href: "/dashboard",   icon: LayoutDashboard, label: "舵手ボード" },
